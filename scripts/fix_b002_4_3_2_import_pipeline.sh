...
echo "Rebuilding ImportPipeline with ConfidenceEngine integration..."

cat > src/meridianforge/services/import_pipeline.py <<'PYTHON'
"""
...
black src/meridianforge/services/import_pipeline.py

echo "ImportPipeline rebuild complete."
